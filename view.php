...
/**
 * This is a copy of mod/hvp/view.php with extra $embedded param and js for frame handling.
 *
 * @package    mod_hvp
...
// New param added for hvpinsert stuff.
...
// Configure page.
$PAGE->set_url(new \moodle_url('/filter/hvpinsert/view.php', array('id' => $id)));

if($embedded) { // New param added for hvpinsert stuff.
    $PAGE->set_pagelayout('popup');
    $PAGE->requires->js(new moodle_url('/filter/hvpinsert/js/iframeResizer.contentWindow.min.js'), true);
}
